 ...
 */
public class CombineitemSynchronizeRequest extends QimenRequest<CombineitemSynchronizeResponse> {
	...
	* 仓库编码
	...
	public Class<CombineitemSynchronizeResponse> getResponseClass() {
		return CombineitemSynchronizeResponse.class;
	}
