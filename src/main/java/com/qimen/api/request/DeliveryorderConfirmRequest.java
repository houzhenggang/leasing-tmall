 ...
 */
public class DeliveryorderConfirmRequest extends QimenRequest<DeliveryorderConfirmResponse> {
	...
	* 包裹信息
	...
	public Class<DeliveryorderConfirmResponse> getResponseClass() {
		return DeliveryorderConfirmResponse.class;
	}
