 ...
 */
public class SingleitemSynchronizeRequest extends QimenRequest<SingleitemSynchronizeResponse> {
	...
	* 仓库编码(统仓统配等无需ERP指定仓储编码的情况填OTHER)
	...
	public Class<SingleitemSynchronizeResponse> getResponseClass() {
		return SingleitemSynchronizeResponse.class;
	}

	public void check() throws ApiRuleException {
		RequestCheckUtils.checkNotEmpty(actionType, "actionType");
		RequestCheckUtils.checkMaxLength(actionType, 10, "actionType");
		RequestCheckUtils.checkNotEmpty(ownerCode, "ownerCode");
		RequestCheckUtils.checkMaxLength(ownerCode, 50, "ownerCode");
		RequestCheckUtils.checkMaxLength(supplierCode, 50, "supplierCode");
		RequestCheckUtils.checkMaxLength(supplierName, 200, "supplierName");
