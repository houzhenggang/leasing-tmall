...
public abstract class Constants {
	...
	/** SDK版本号 */
	public static final String SDK_VERSION = "top-sdk-java-20170428";

	/** 异步多活SDK版本号 */
	public static final String SDK_VERSION_CLUSTER = "top-sdk-java-cluster-20170428";
	
	/** httpdns SDK版本号 */
    public static final String SDK_VERSION_HTTPDNS = "top-sdk-java-httpdns-20170428";
